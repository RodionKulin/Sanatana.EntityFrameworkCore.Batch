...
namespace Sanatana.EntityFrameworkCore.Scripts
{
    public class ScriptManager
    {
        ...
        private List<string> GetSqlNamesOfIndexes(DbContext dbContext)
        {
            ...
            , string checkExistingTableSchema, string checkExistingTableName)
        {
            ...
            int? existingNumber = (int?)command.ExecuteScalar();
            bool exists = existingNumber != null && existingNumber.Value > 0;
