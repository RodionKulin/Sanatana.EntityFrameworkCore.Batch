...
namespace Sanatana.EntityFrameworkCore
{
    public static class DbContextExtensions
    {
        ...
        /// <param name="context">DbContext</param>
        /// <param name="rootEntityType">Entity type to find property of. In case of owned entity specify parent entity type.</param>
        /// <param name="property">Property of entity. In case of owned entity specify propertyName of format of "NavigationProperty_OwnedEntityProperty".</param>
        /// <returns></returns>
