...
namespace Sanatana.EntityFrameworkCore.Batch.SqlServerSpecs.Specs.Commands
{
    ...
    {
        [TestFixture]
        public class when_updating_many : SpecsFor<SqlRepository>
           , INeedSampleDatabase
        {
        ...
        [TestFixture]
        public class when_updating_limited_number_of_rows : SpecsFor<SqlRepository>
           , INeedSampleDatabase
        {
            private Guid _commonGuidValue = Guid.NewGuid();
            private int _entitiesCount = 10;
        ...
        [TestFixture]
        public class when_updating_many_with_output : SpecsFor<SqlRepository>
           , INeedSampleDatabase
        {
            private Guid _commonGuidValue = Guid.NewGuid();
            private int _entitiesCount = 10;
