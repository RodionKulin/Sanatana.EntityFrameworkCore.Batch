...
namespace Sanatana.EntityFrameworkCore.Batch.PostgreSqlSpecs.Specs.Commands
{
    public class InsertCommandSpecs
    {
        ...
        [TestFixture]
        public class when_inserting_multiple_entities : SpecsFor<PostgreRepository>
           , INeedSampleDatabase
        {
        ...
        [TestFixture]
        public class when_inserting_multiple_entities_with_output : SpecsFor<PostgreRepository>
           , INeedSampleDatabase
        {
            public SampleDbContext SampleDatabase { get; set; }
        ...
        [TestFixture]
        public class when_inserting_collection_navigation_property : SpecsFor<PostgreRepository>
           , INeedSampleDatabase
        {
        ...
        [TestFixture]
        public class when_inserting_complex_property : SpecsFor<PostgreRepository>
           , INeedSampleDatabase
        {
            public SampleDbContext SampleDatabase { get; set; }
